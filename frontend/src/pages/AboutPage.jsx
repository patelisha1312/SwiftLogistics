...
const AboutPage = () => {
  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      {/* Hero Section */}
      <section className="relative h-[90vh] flex flex-col items-center justify-center text-center text-white bg-gradient-to-br from-purple-800 to-purple-900 overflow-hidden">
