...
const [topRoutesData, setTopRoutesData] = useState([]);
  ...
  AI manages driver allocation, ETA prediction, and route optimization across the system.
</p>
  ...
  try {
    ...
    const [
      ...
      axios.get("http://swiftlogictics-backend.onrender.com/api/admin/dashboard-stats"),
      axios.get("http://swiftlogictics-backend.onrender.com/api/admin/monthly-revenue"),
      axios.get("http://swiftlogictics-backend.onrender.com/api/admin/shipment-status"),
      axios.get("http://swiftlogictics-backend.onrender.com/api/admin/daily-activity"),
      axios.get("http://swiftlogictics-backend.onrender.com/api/admin/top-routes")
    ]);
console.log("🔥 DASHBOARD:", stats.data);
    setDashboardStats({ ...stats.data });
    setMonthlyRevenueData(revenue.data);
    setShipmentStatusData(status.data);
    setDailyActivityData(activity.data);
    setTopRoutesData(routes.data);
...
useEffect(() => {
  const socket = io("http://swiftlogictics-backend.onrender.com");
...
const downloadCSV = () => {
  window.open("http://swiftlogictics-backend.onrender.com/api/admin/export/csv");
};

const downloadPDF = () => {
  window.open("http://swiftlogictics-backend.onrender.com/api/admin/export/pdf");
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
          <StatCard 
            ...
            value={dashboardStats?.totalShipments?.toLocaleString() || "0"} 
            trend={8.2}
            subtitle="This month"
          />
          <StatCard 
            icon={DollarSign} 
            title="Total Revenue" 
         value={formatRevenue(dashboardStats?.totalRevenue)}
            trend={12.5}
            subtitle="This month"
            color="green"
          />
          ...
          <StatCard 
            ...
            value={dashboardStats?.pendingPickups || 0} 
...
<div className="grid md:grid-cols-3 gap-6 mb-8">
  ...
  {/* USERS */}
  <div className="bg-gradient-to-br from-purple-600 to-purple-800 rounded-xl shadow-lg p-6 text-white hover:scale-105 transition">
    ...
    <button
      ...
      className="bg-white text-purple-700 px-4 py-2 rounded-lg font-medium"
    >
      Go to Users
    </button>
  </div>
  ...
  {/* DRIVERS */}
  <div className="bg-gradient-to-br from-green-600 to-green-800 rounded-xl shadow-lg p-6 text-white hover:scale-105 transition">
    <div className="flex items-center justify-between mb-4">
      <h4 className="text-lg font-bold">Manage Drivers</h4>
      <Truck className="h-6 w-6" />
    </div>

    <p className="text-sm text-green-200 mb-4">
      Monitor drivers, availability and performance.
    </p>
  ...
  {/* BOOKINGS */}
  <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl shadow-lg p-6 text-white hover:scale-105 transition">
    <div className="flex items-center justify-between mb-4">
      <h4 className="text-lg font-bold">Manage Bookings</h4>
      <Package className="h-6 w-6" />
    </div>

    <p className="text-sm text-blue-200 mb-4">
      Track and manage all shipment bookings.
    </p>
